...
Documentations : 
- :book: [Markdown Docs](https://daringfireball.net/projects/markdown/)
- :baby: [Basic syntaxes](https://markdownguide.offshoot.io/basic-syntax/)
- :muscle: [Advanced syntaxes](https://markdownguide.offshoot.io/extended-syntax/)
